...
int timer_configuration(int timer, int interval, enum 13223_time_units) 
{
    ...
    {
        printf("Error in timer_configuration() - seslecting timer! \n");
        return 1;
    ...
    {
        printf("Error in timer_configuartion() - selecting time unit! \n");
    ...
    {
        printf("Error in timer_configuarion() - sys_outb MSB to timer! \n");
