...
int timer_configuration(int timer, int interval, enum 13223_time_units unit) 
{
    ...
    control_word = occntrol_word | ALARM_MODE;
    ...
    if (sysy_outb(TIMER_0 + timer, msb) != 0)
    ~{
...
int pp_test_alarm(int timer, int interval, enum 13223_time_unit);
{
