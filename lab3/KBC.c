...
// ler os caracters pressionados no ecrâ
// A informação só deve ser lida quando o output buffer estiver cheio
int read_KBC_output(uint8_t port, uint8_t *output, uint8_t mouse) {
    ...
    while (attemps) {
        ...
        // assegura o intervalo correto entre tentativas de acordo com os ticks do processador
        tickdelay(micros_to_ticks(20000));  //traduz um número inteiro de microssegundos em ticks
        attemps--;
    }
